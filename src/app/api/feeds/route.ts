...
export const FEEDS: LiveFeed[] = [
  ...
  },
  {
    id: "realvision",
    label: "REAL VISION",
    sublabel: "US — MACRO ALPHA",
    channelId: "UCJNXBgHFnWmBBSBdMUMByYw",
    category: "markets",
    region: "US",
    accentColor: "var(--signal-cyan)",
  },
  ...
  // ─── DEGEN ──────────────────────────────────────────────────────────────────
  {
    id: "coffeezilla",
    label: "COFFEEZILLA",
    sublabel: "DEGEN — EXPOSING SCAMS",
    channelId: "UCFGGxqces5NwnFeHs-uNtUw",
    category: "degen",
    accentColor: "var(--signal-amber)",
  },
  {
    id: "coinbureau",
    label: "COIN BUREAU",
    sublabel: "DEGEN — DEEP RESEARCH",
    channelId: "UCqK_GSMbpiV8spgD3ZGloSw",
    category: "degen",
    accentColor: "var(--signal-cyan)",
  },
  {
    id: "intothecryptoverse",
    label: "INTO THE CRYPTOVERSE",
    sublabel: "DEGEN — ON-CHAIN DATA",
    channelId: "UCRvqjQPSeaWn-uEx-w0XLIg",
    category: "degen",
    accentColor: "var(--signal-green)",
  },
  {
    id: "paulbarron",
    label: "PAUL BARRON NETWORK",
    sublabel: "DEGEN — CRYPTO SIGNALS",
    channelId: "UCYNFHFz2bnYTSMh5RkGXv9Q",
    category: "degen",
    accentColor: "var(--signal-red)",
  },
];
